...
echo "---$FILE---"
#bin/console -P $password --user REDACTED --ssh --from $FILE --sshtasks Chef_server_url
#bin/console -P $password --user REDACTED --ssh --from $FILE --sshtasks Chef_run
bin/console -P $password --user REDACTED --ssh --from $FILE --sshtasks Chef_set_url_onpremises
